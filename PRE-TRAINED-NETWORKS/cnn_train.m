function [net, stats] = cnn_train(folder, set_training, set_testing, net, imdb, getBatch, varargin)
...
modelPath = @(ep) fullfile(opts.expDir, sprintf([num2str(folder) '-' num2str(set_training) '-' num2str(set_testing) '-net-epoch-%d.mat'], ep));
